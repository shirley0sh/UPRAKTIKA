...
<head>
    <meta charset="UTF-8">
    <title>Graph Editor - Kruskal</title>
    ...
    <div class="container">
        <div id="toolbar" class="toolbar">
            <div class="toolbar-header">
                ...
                <a href="/" class="kruskal-title-link" title="Перейти к теоретическому описанию алгоритма Краскала">
                    🌲 Алгоритм Краскала
                </a>
            </div>
            ...
            <div id="result-panel" class="result-panel" style="display: none;">
                <div class="result-title">🌳 Минимальное остовное дерево</div>
                <div id="result-edges" class="result-edges"></div>
                <div id="total-weight" class="total-weight"></div>
            </div>

            <!-- Кнопки действий -->
            <div class="action-buttons">
                <button id="kruskal-btn" class="btn btn-primary">🔍 Найти минимальный остов</button>
            ...
            <div class="info-panel">
                ...
                <p>Краскала находит минимальное остовное дерево (MST) во взвешенном неориентированном графе.</p>
                <p><strong>Сложность:</strong> O(E·log E)</p>
                <p><span class="shortcut">💡 Совет:</span> Дважды кликните по ребру, чтобы задать вес</p>
                <p><span class="shortcut">🌲 Результат:</span> Рёбра MST подсвечиваются зелёным</p>
            </div>
        </div>
